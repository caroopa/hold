...
export class CircleComponent {
  ...
  morphing() {
    ...
    const innerMorphPath =
      'M255.562 334.26C228.92 401.5 134.59 313.5 126.893 282.26C101.393 178.76 37.5 147.5 83.3927 127.26C217.562 78.2598 225.166 24.5 278.5 64.0392C358.652 123.459 300.732 220.26 255.562 334.26Z';
    const duration = 2500;
