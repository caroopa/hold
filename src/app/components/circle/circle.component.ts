...
export class CircleComponent {
  ...
  morphing() {
    ...
    const innerMorphPath =
      'M188.562 284.26C161.92 351.5 67.5896 263.5 59.8928 232.26C34.3928 128.76 -29.5 97.5 16.3927 77.2597C150.562 28.2598 158.166 -25.5 211.5 14.0392C291.652 73.4594 233.732 170.26 188.562 284.26Z';
    const duration = 2500;
